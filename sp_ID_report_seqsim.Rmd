...
Species identification method used: **Sequence similarity**  
...
Substitution model = **`r params$model`**  
Number of hits reported = **`r params$hits`**  
...
seqsim <- seqsimilarityID(DNAbin = x,
                model = params$model,
                hits = params$hits)
library(kableExtra)
library(knitr)
